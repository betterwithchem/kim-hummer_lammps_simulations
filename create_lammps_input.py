...
parser.add_argument("-f", dest="conffile",required=True, type=str, 
                    help="data file of the starting configuration.")
parser.add_argument("-coeffs", dest="pair_coeffs_data", required=True, type=str, 
                    help="Name of the file with the pair coefficients for the non-bonded interactions.")
parser.add_argument("-o", dest="lammps_inputfile", required=False, type=str, 
                    help="Name of the generated LAMMPS input file.")
parser.add_argument("-log", dest="lammps_log_file", required=False, type=str, default="lmp.log", 
                    help="Name of the log file generated by the simulation" )
parser.add_argument("-dcd", dest="lammps_dcd_file", required=False, type=str, default="lmp.dcd", 
                    help="Name of the dcd trajectory file generated by the simulation " )

parser.add_argument("-temp", dest="temperature", required=False, type=float, default=300, 
                    help="Temperature of the simulation in K")
parser.add_argument("-nsteps", dest="nsteps", required=False, type=int, default=1000, 
                    help="Number of integration steps")

parser.add_argument("-rigid", dest="rigid", required=False, type=str, 
                    help="include file name with the rigid body commands")

parser.add_argument("-deffnm", dest="deffnm", required=False, type=str, 
                    help="use a single name for .in, .log, and .dcd files. It ovverrides any -o, -log, and -dcd inputs.")
